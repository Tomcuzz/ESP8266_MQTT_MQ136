...
const char *hass_config = "{\"name\":\"bathroom_h2s\", \"unique_id\":\"bathroom_h2s\", \"device\":{\"identifiers\":[\"bathroom_h2s\"], \"manufacturer\":\"tcousin\", \"model\":\"Gass Sensor V1\", \"name\":\"bathroom_h2s\"}, \"availability\":{\"topic\":\"h2s_sensor/bathroom/status\", \"payload_available\":\"online\", \"payload_not_available\":\"offline\"}, \"icon\":\"mdi:scent\", \"state_topic\":\"h2s_sensor/bathroom/value\", \"device_class\":\"volatile_organic_compounds_parts\", \"unit_of_measurement\":\"ppm\"}";
